...
public class Day22 {
    private static final Brick GROUND = new Brick(0, Integer.MAX_VALUE, 0, Integer.MAX_VALUE, 0, 0);
    ...
    public static class Brick {
        ...
        static Brick scanIn(String line) {
            ...
            return new Brick(p1.get(0), p1.get(1), p1.get(2), p2.get(0), p2.get(1), p2.get(2));
        }
