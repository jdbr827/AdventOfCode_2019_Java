...
public class Day11 {
    ...
    /**
     * Executes one read-paint-rotate-move set of steps if one is remaining.
     * @return whether a set was remaining
     */
